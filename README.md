...
REST API доступен по адресу `http://45.12.72.15:8182/api/`.
...
WebSocket API доступен по адресу `ws://45.12.72.15:8181/ws`.
...
JSON-RPC API доступен по адресу `http://45.12.72.15:8545`.
