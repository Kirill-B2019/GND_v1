...
- Для клиентских сценариев — используйте REST и WebSocket API (документация: **api.gnd-net.com**, описание в **docs/api.md**).
...
- [api.md](docs/api.md) — описание API (публичный хост: api.gnd-net.com)
