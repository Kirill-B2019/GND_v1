...
[^3]: README.md в корне проекта и docs/README.md.
[^4]: api/middleware.go — middleware для API.
[^5]: api/rest.go — REST API.
[^6]: api/rpc.go — JSON-RPC API.
[^7]: api/websocket.go — WebSocket API.
