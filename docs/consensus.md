...
- **Контракты валидируются по PoA** — создание и верификация смарт-контрактов (деплой, верификация) проходят по механизму Proof of Authority.
- **Транзакции внутри контрактов валидируются по PoS** — вызовы методов контрактов, переводы токенов и прочие операции, выполняемые в контексте контракта, валидируются по механизму Proof of Stake.
