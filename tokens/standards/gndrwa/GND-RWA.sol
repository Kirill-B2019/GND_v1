...
/// @title GND-RWA: токен реальных активов для блокчейна ГАНИМЕД
/// @notice Управляется контрактом-контроллером; пауза, заморозка, cap; KYC, snapshot/дивиденды, модули.
/// @dev Расширения как в GNDst-1: KycStatusChanged, SnapshotCreated, DividendClaimed, ModuleRegistered.
